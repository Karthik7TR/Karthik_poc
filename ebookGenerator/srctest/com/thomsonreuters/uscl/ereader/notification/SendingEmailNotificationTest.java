...
public final class SendingEmailNotificationTest
{
    @Spy
    @InjectMocks
    ...
    public void emailBodyContainsBookPartsInfo()
    {
        ...
        // when
        final String bookPartsInfo = sendingEmailNotification.getBookPartsAndTitle(info);
        // then
    ...
    public void metricsInfoIsCorrect()
    {
        ...
        // when
        final String metricsInfo = sendingEmailNotification.getMetricsInfo(info);
        // then
    ...
    public void emailSubjectForNormalBookIsCorrect()
    {
        ...
        // when
        final String subject = sendingEmailNotification.getSubject(info);
        // then
    ...
    public void emailBodyContainsBasicInfo()
    {
        ...
        // when
        final String subject = sendingEmailNotification.getBody(info);
        // then
    ...
    public void currentVersionInfoIsCorrect()
    {
        ...
        // when
        final String versionInfo = sendingEmailNotification.getVersionInfo(true, info);
        // then
    ...
    public void previousVersionInfoIsCorrect()
    {
        ...
        // when
        final String versionInfo = sendingEmailNotification.getVersionInfo(false, info);
        // then
