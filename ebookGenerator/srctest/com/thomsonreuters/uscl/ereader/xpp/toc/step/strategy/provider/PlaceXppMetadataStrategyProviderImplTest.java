...
public final class PlaceXppMetadataStrategyProviderImplTest {
    ...
    public void shouldReturnSummaryTableOfContentsStrategy() {
        testStrategyProvider(
            "100018-volume_1_Summary_Table_of_Contents.DIVXML.xml",
    ...
    public void shouldReturnAddedRevisedJudgesCardsStrategy() {
        testStrategyProvider(
            "100018-volume_1_AddedRevised_Judges_Cards.DIVXML.xml",
            BundleFileType.ADDED_REVISED_JUDGES_CARDS);
    }
    ...
    public void shouldReturnDetailedTableOfContentsStrategy() {
        testStrategyProvider(
            "30002-volume_3_Detailed_Table_of_Contents.DIVXML.xml",
    ...
    public void shouldReturnSummaryAndDetailedTableOfContentsStrategy() {
        testStrategyProvider(
            "10002-volume_1_Summary_and_Detailed_Table_of_Contents.DIVXML.xml",
            BundleFileType.SUMMARY_AND_DETAILED_TABLE_OF_CONTENTS);
    }

    @Test
    public void shouldReturnTableOfAddedKeyNumbersStrategy() {
        testStrategyProvider(
            "100018-volume_1_Table_of_Added_Key_Numbers.DIVXML.xml",
    ...
    private void testStrategyProvider(final String fileName, final BundleFileType expectedFileType) {
        final BundleFileHandlingStrategy strategy =
            tocGenerationStrategyProvider.getStrategy(BundleFileType.getByFileName(fileName));
