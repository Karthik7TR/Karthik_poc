...
public final class DocumentNameTest
{
    ...
    private static final String CORRECT_FILE_NAME =
        BASE_FILE_NAME + "_" + ORDER + "_" + DOC_FAMILY_UUID + ".html";
    private static final String FILE_NAME_WITH_INVALID_ORDER =
        BASE_FILE_NAME + "_5five_" + DOC_FAMILY_UUID + ".html";
    private static final String FILE_NAME_WITHOUT_ORDER =
        BASE_FILE_NAME + "_" + DOC_FAMILY_UUID + ".html";
    private static final String FILE_NAME_WITH_INVALID_UUID =
        BASE_FILE_NAME + "_" + ORDER + "_" + "64723846hgfs-dsfsdfsdf23" + ".html";
    private static final String FILE_NAME_WITHOUT_UUID =
        BASE_FILE_NAME + "_" + ORDER + "_" + ".html";
