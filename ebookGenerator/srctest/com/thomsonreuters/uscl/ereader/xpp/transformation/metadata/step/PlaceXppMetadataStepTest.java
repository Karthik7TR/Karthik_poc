...
import com.thomsonreuters.uscl.ereader.xpp.transformation.metadata.step.PlaceXppMetadataStep;
...
public final class PlaceXppMetadataStepTest
{
    ...
    public void onTestSetUp()
    {
        ...
        given(fileSystem.getStructureWithMetadataFile(Matchers.eq(step), Matchers.eq(MATERIAL_NUMBER), Matchers.anyString())).willReturn(bundleDirectory);
    }
    ...
    public void shouldTransform() throws Exception
    {
        ...
        //then
        then(strategyProvider.getStrategy(BundleFileType.FRONT)).should().performHandling(frontFile, MATERIAL_NUMBER, step);
    }
}
