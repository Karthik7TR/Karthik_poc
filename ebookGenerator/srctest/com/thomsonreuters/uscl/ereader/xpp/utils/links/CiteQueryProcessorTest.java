...
public final class CiteQueryProcessorTest {
    private final String expected =
        "https://1.next.westlaw.com/Link/Document/FullText?findType=L&pubNum=1000259&cite=WAST71.34.710&originatingDoc=I0d85b630627211e78600cc06009ba385&refType=LQ&originationContext=ebook";
    ...
    public void shouldCreateLinkFromSiteQuery() throws Exception {
        ...
        //when
        final String result = new CiteQueryProcessor().getLink(input);
        //then
