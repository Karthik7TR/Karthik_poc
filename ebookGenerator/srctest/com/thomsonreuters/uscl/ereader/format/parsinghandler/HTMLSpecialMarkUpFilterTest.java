...
public class HTMLSpecialMarkUpFilterTest {
	...
	public void testDelElements() throws SAXException
	{
		...
		String expectedResult = "<div class=\"co_paragraphText\">It is the duty of a pro se party needing an interpreter or counsel for a party needing an interpreter to notify the clerk of the district court 10 days prior to any hearing of the need for an interpreter. It shall be specified whether an interpreter is needed for one of the parties and/or one or more witnesses. It is not permissible for the parties to use a friend or relative as an interpreter. The cost for an interpreter is not assessed to the parties.</div>";
