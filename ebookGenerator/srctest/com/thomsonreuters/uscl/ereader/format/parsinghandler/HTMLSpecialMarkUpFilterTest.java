 ...
 */
public final class HTMLSpecialMarkUpFilterTest
{
    ...
    {
        final String xmlTestStr = "<del><ins>and</ins></del>";
        final String expectedResult =
            "<span class=\"co_crosshatch\"><span style=\"background-color: #ccffff; color: #000000; text-decoration: none;\">and</span></span>";
    ...
    {
        final String xmlTestStr = "<del>and</del>";
        final String expectedResult = "<span class=\"co_crosshatch\">and</span>";
    ...
    {
        final String xmlTestStr = "<del><ins><name>nirupam</name>and</ins></del>";
        final String expectedResult =
            "<span class=\"co_crosshatch\"><span style=\"background-color: #ccffff; color: #000000; text-decoration: none;\"><name>nirupam</name>and</span></span>";
    ...
    public void testDelElements() throws SAXException
    {
        ...
        final String expectedResult =
            "<div class=\"co_paragraphText\"><span style=\"background-color: #ccffff; color: #000000; text-decoration: none;\">It is the duty of a pro se party needing an interpreter or counsel for a party needing an interpreter to notify the clerk of the district court 10 days prior to any hearing of the need for an interpreter. It shall be specified whether an interpreter is needed for one of the parties and/or one or more witnesses. It is not permissible for the parties to use a friend or relative as an interpreter. The cost for an interpreter is not assessed to the parties.</span></div>";
