...
public class HTMLCreateNamedAnchorsServiceTest {
	...
	/**
	 * TransformHTML should take a source directory with ".posttransform" files generated by HTMLTransformerService 
	 * and perform the fourth step necessary to transform them into html files. The resulting ".postanchor" files are
	...
	/**
	 * test alternative logical branches not taken by the happy path, including a 
	 * given document to Table of Contents map file.
	 */
	@Test
	...
	/**
	 * Test the exception throwing of HTMLCreateNamedAnchrosService as a response to 
	 * a source directory that is null or contains no .posttransform files
	 */
	@Test
