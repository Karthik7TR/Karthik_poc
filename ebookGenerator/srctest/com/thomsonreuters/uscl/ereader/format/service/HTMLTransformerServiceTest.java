...
public class HTMLTransformerServiceTest {
    ...
    public void setUp(){
		...
		//FileHandlingHelper fileHelper = EasyMock.createMock(FileHandlingHelper.class);	// cannot mock pass-by-reference behavior
	...
	/**
	 * TransformHTML should take a source directory with ".transformed" files generated by TransformerService 
	 * and perform the third step necessary to transform them into html files. The resulting ".postTransform" files are
	...
	/**
	 * Tests the case were there are more table viewers than .transformed files to process. Should
	 * throw an EBookFormatException. 
	 */
	@Test
	...
	public void testExceptions()
	{
		...
		boolean expect = false;
		try{
			transformerService.transformHTML(null, targetDir, staticImgList, tableViewers, title, jobId, 
					targetAnchors, docsGuidFile, deDuppingFile, isHighlight, isStrikethrough, delEditorNodeHeading, version);
