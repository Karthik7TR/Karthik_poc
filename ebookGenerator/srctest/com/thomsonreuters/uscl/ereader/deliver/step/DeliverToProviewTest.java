...
public final class DeliverToProviewTest
{
    ...
    public void testRetry() throws ProviewException
    {
        ...
        {
            Assert.assertEquals(true, ex.getMessage().contains("Tried 3 t" + "imes"));
            thrown = true;
        }
    ...
    public void testRetryRemove() throws ProviewException
    {
        ...
        {
            Assert.assertEquals(false, ex.getMessage().contains("Tried 3 t" + "imes"));
            thrown = true;
        }
