...
public class SplitTocManifestFilterTest extends TitleMetadataTestBase {
	...
	public void setUp() throws Exception {
		...
		splitTocManifestFilterTest = new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(),
				uuidGenerator, temporaryDirectory, mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
	...
	public void testVoidInput() throws Exception {
		// titleMetadata test
		try {
			new SplitTocManifestFilter(null, new HashMap<String, String>(), uuidGenerator, temporaryDirectory,
					mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
		...
		// docImage Map test
		try {
			new SplitTocManifestFilter(titleMetadata, null, uuidGenerator, temporaryDirectory, mockFileUtilsFacade,
					mockPlaceholderDocumentService, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
			e.printStackTrace();
		...
		// uuidGenerator test
		try {
			new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(), null, temporaryDirectory,
					mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
		...
		try {
			new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(), uuidGenerator, null,
					mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
		...
		try {
			new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(), uuidGenerator, new File("test"),
					mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
		...
		try {
			new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(), uuidGenerator, temporaryDirectory,
					null, mockPlaceholderDocumentService, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
			e.printStackTrace();
		...
		try {
			new SplitTocManifestFilter(titleMetadata, new HashMap<String, String>(), uuidGenerator, temporaryDirectory,
					mockFileUtilsFacade, null, docImageMap);
			fail("Should throw IllegalArugmentException");
		} catch (IllegalArgumentException e) {
			// expected exception
			e.printStackTrace();
	...
	public void testTitleManifestFilterHappyPath() throws Exception {
		...
		InputStream immigrationProceduresHandbook = SplitTocManifestFilterTest.class
				.getResourceAsStream("SPLIT_TOC.xml");
	...
	public void testFamilyGuidReplacementHappyPath() throws Exception {
		...
		SplitTocManifestFilter filter = new SplitTocManifestFilter(titleMetadata, familyGuidMap, uuidGenerator,
				temporaryDirectory, mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
	...
	public void testDuplicateDocGuidHappyPath() throws Exception {
		...
		String expectedToc = EXPECTED__SPLIT_TOC
		...
		SplitTocManifestFilter filter = new SplitTocManifestFilter(titleMetadata, familyGuidMap, mockUuidGenerator,
				temporaryDirectory, mockFileUtilsFacade, mockPlaceholderDocumentService, docImageMap);
	...
	public void testCaFedRules2012WithoutDeletedNodes() throws Exception {
		InputStream caFedRules2012 = SplitTocManifestFilterTest.class
		...
		InputSource result = new InputSource(new ByteArrayInputStream(resultStream.toByteArray()));
		InputSource expected = new InputSource(SplitTocManifestFilterTest.class
