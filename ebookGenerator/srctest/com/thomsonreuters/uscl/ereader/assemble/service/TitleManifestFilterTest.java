...
public final class TitleManifestFilterTest extends TitleMetadataTestBase {
    ...
    private static final String EXPECTED_KEYWORDS =
        "<keywords><keyword type=\"publisher\">High Seas Trading Company</keyword><keyword type=\"jurisdiction\">International Waters</keyword></keywords>";
    ...
    private static final String EXPECTED_START_MANIFEST_PREFIX =
        "<title apiversion=\"v1\" titleversion=\"v1\" id=\"yarr/pirates\" lastupdated=\"";
    private static final String EXPECTED_START_MANIFEST_SUFFIX =
        "\" language=\"eng\" status=\"Review\" onlineexpiration=\"";
    private static final String EXPECTED_START_MANIFEST_SUFFIX_SINGLETON =
        "\" language=\"eng\" status=\"Review\" onlineexpiration=\"";
    private static final String EXPECTED_TOC =
    ...
    private static final String EXPECTED_DOCS_TOC_ENTRIES =
        "<docs><doc id=\"FrontMatterTitle\" src=\"FrontMatterTitle.html\"/><doc id=\"Copyright\" src=\"Copyright.html\"/><doc id=\"ResearchAssistance\" src=\"ResearchAssistance.html\"/><doc id=\"Westlaw\" src=\"Westlaw.html\"/>";
    private static final String EXPECTED_ALT_ID_ENTRIES =
        "<docs><doc id=\"FrontMatterTitle\" altid=\"9 doc_0001\" src=\"FrontMatterTitle.html\"/><doc id=\"Copyright\" altid=\"3 doc_0002\" src=\"Copyright.html\"/><doc id=\"ResearchAssistance\" altid=\"3 doc_0004\" src=\"ResearchAssistance.html\"/><doc id=\"Westlaw\" altid=\"1 doc_0005\" src=\"Westlaw.html\"/>";
    private static final String EXPECTED_DOCS =
        EXPECTED_DOCS_TOC_ENTRIES + "<doc id=\"DOC_GUID\" src=\"DOC_GUID.html\"/></docs>";
    ...
    public void testWriteAssets() throws Exception {
        ...
        Assert
            .assertEquals(EXPECTED_ASSETS + EXPECTED_ISBN + EXPECTED_END_MANIFEST, resultStreamToString(resultStream));
    }
    ...
    public void testWriteAuthors() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert
            .assertEquals(EXPECTED_AUTHORS + EXPECTED_ISBN + EXPECTED_END_MANIFEST, resultStreamToString(resultStream));
    }
    ...
    public void testWriteKeywords() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert.assertEquals(
            EXPECTED_KEYWORDS + EXPECTED_ISBN + EXPECTED_END_MANIFEST,
    ...
    public void testWriteCopyright() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert.assertEquals(
            EXPECTED_COPYRIGHT + EXPECTED_ISBN + EXPECTED_END_MANIFEST,
            resultStreamToString(resultStream));
    }
    ...
    public void testWriteFeatures() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert.assertEquals(
            EXPECTED_FEATURES + EXPECTED_ISBN + EXPECTED_END_MANIFEST,
            resultStreamToString(resultStream));
    }
    ...
    public void testWriteMaterialId() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert.assertEquals(
            EXPECTED_MATERIAL_ID + EXPECTED_ISBN + EXPECTED_END_MANIFEST,
            resultStreamToString(resultStream));
    }
    ...
    public void testWriteCoverArt() throws Exception {
        ...
        titleManifestFilter.endDocument();
        Assert
            .assertEquals(EXPECTED_ARTWORK + EXPECTED_ISBN + EXPECTED_END_MANIFEST, resultStreamToString(resultStream));
    }
    ...
    public void testDuplicateDocGuidHappyPath() throws Exception {
        ...
        final String expectedDocs = EXPECTED_DOCS_TOC_ENTRIES
    ...
    public void testWriteTocNodeHappyPath() throws Exception {
        ...
        final String expected =
            "<toc><entry s=\"DOC1/TOC1\"><text>FOO</text></entry><entry s=\"DOC2/TOC2\"><text>BAR</text></entry><entry s=\"DOC3/TOC3\"><text>BAZ</text><entry s=\"DOC3.1/TOC3.1\"><text>BASIL</text></entry></entry></toc>"
                + EXPECTED_ISBN
                + "</title>";
    ...
    public void testAlternativeId() throws Exception {
        ...
        final Map<String, String> altIdMap = titleMetadataService.getAltIdMap("yarr_pirates", altIdFile.getParent());
        ...
        final String expectedDocs = EXPECTED_ALT_ID_ENTRIES
