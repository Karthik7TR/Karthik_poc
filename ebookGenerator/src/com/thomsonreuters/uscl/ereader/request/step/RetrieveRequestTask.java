...
public class RetrieveRequestTask extends AbstractSbTasklet {
	...
	public ExitStatus executeStep(StepContribution contribution, ChunkContext chunkContext) {
		...
		String request = (String) chunkContext.getStepContext().getJobParameters().get(EBookRequest.KEY_REQUEST_XML);
	...
	private void archiveRequest(EBookRequest request) throws MessageQueueException {
