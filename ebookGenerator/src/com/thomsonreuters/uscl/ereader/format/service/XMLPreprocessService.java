...
public interface XMLPreprocessService {
	 ...
	 */
	public int transformXML(final File srcDir, final File targetDir, final boolean isFinalStage,
			 final List<DocumentCopyright> copyrights, final List<DocumentCurrency> currencies) throws EBookFormatException;
}
