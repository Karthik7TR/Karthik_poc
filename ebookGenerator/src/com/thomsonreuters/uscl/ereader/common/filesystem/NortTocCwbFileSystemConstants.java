...
public enum NortTocCwbFileSystemConstants {
    ...
    FORMAT_TRANSFORMED_DIR("04.Transformed"),
    FORMAT_SPLIT_TOC_DIR("05.splitToc"),
    FORMAT_POST_TRANSFORM_DIR("06.PostTransform"),
    FORMAT_CREATED_LINKS_TRANSFORM_DIR("07.CreatedLinksTransform"),
    FORMAT_FIXED_TRANSFORM_DIR("08.FixedTransform"),
    FORMAT_HTML_WRAPPER_DIR("09.HTMLWrapper"),
    FORMAT_PROCESS_PAGES_DIR("10.ProcessPages"),
    FORMAT_SPLIT_EBOOK_DIR("11.splitEbook"),
