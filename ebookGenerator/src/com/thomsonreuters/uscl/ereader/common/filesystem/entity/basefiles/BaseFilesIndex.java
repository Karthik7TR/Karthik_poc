...
public class BaseFilesIndex
{
    ...
    public void put(@NotNull final String materialNumber, @NotNull final String baseName, @NotNull final PartType type, @NotNull final File file)
    {
    ...
    @NotNull
    public File get(@NotNull final String materialNumber, @NotNull final String baseName, @NotNull final PartType type) {
