...
@SavePublishingStatusService(StatsUpdateTypeEnum.FINALPUBLISH)
public class DeliverPublishingStatusUpdateService extends BasePublishingStatusUpdateService
{
    /* (non-Javadoc)
