ALTER TABLE "EBOOK_TEST".EBOOK_DEFINITION ADD (ELOOSELEAFS_ENABLED CHAR(1 BYTE) DEFAULT 'N' NOT NULL);

ALTER TABLE "EBOOK_TEST".EBOOK_AUDIT ADD (ELOOSELEAFS_ENABLED CHAR(1 BYTE) DEFAULT 'N' NOT NULL);
