ALTER TABLE EBOOK_QA.EBOOK_DEFINITION ADD (INLINE_TOC_INCLUDED CHAR(1 BYTE) DEFAULT 'N' NOT NULL);

ALTER TABLE EBOOK_QA.EBOOK_AUDIT ADD (INLINE_TOC_INCLUDED CHAR(1 BYTE) DEFAULT 'N' NOT NULL);
