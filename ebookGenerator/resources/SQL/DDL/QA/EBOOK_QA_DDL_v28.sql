ALTER TABLE EBOOK_QA.EBOOK_DEFINITION ADD (PRINT_PAGE_NUMBERS CHAR(1 BYTE) DEFAULT 'N');

ALTER TABLE EBOOK_QA.EBOOK_AUDIT ADD (PRINT_PAGE_NUMBERS CHAR(1 BYTE) DEFAULT 'N');
