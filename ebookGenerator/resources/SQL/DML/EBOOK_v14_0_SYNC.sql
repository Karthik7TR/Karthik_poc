...
INSERT INTO EBOOK.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES ( 14.8, 'Added USER_PREFERENCE.GROUP_NAME_FILTER, USERPREFERENCE.GROUP_ID_FILTER columns.', TO_DATE('05/04/2016', 'MM/DD/YYYY'));
...
INSERT INTO EBOOK.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.9, 'Alter EBOOK_DEFINITION.GROUP_NAME,EBOOK_AUDIT.GROUP_NAME,EBOOK_DEFINITION.SUBGROUP_HEADING,EBOOK_AUDIT.SUBGROUP_HEADING columns.', TO_DATE('04/25/2016', 'MM/DD/YYYY'));
...
ALTER TABLE EBOOK.EBOOK_AUDIT
 ...
 INSERT INTO EBOOK.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.10, 'Alter EBOOK_AUDIT.PROVIEW_TABLE_VIEW_FLAG column.', TO_DATE('04/25/2016', 'MM/DD/YYYY'));
 ...
 INSERT INTO EBOOK.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.10, 'Added EBOOK.PILOT_BOOK table.', TO_DATE('07/06/2016', 'MM/DD/YYYY'));

CREATE TABLE EBOOK.PILOT_BOOK(
...
ALTER TABLE EBOOK.PILOT_BOOK ADD CONSTRAINT PILOT_BOOK_PK PRIMARY KEY (PILOT_BOOK_TITLE_ID, EBOOK_DEFINITION_ID);

ALTER TABLE EBOOK.PILOT_BOOK ADD CONSTRAINT EBOOK_PILOT_BOOK_FK1 FOREIGN KEY (EBOOK_DEFINITION_ID) REFERENCES EBOOK.EBOOK_DEFINITION (EBOOK_DEFINITION_ID);

CREATE INDEX EBOOK.IX_EBOOK_PILOT_BOOK_FK1 ON EBOOK.PILOT_BOOK (EBOOK_DEFINITION_ID);

ALTER TABLE EBOOK.EBOOK_AUDIT
 ADD (PILOT_BOOKS_CONCAT  VARCHAR2(1024 BYTE));

 GRANT DELETE, INSERT, SELECT, UPDATE ON EBOOK.PILOT_BOOK TO EBOOK_USER;
 
CREATE OR REPLACE SYNONYM EBOOK_USER.PILOT_BOOK FOR EBOOK.PILOT_BOOK;
