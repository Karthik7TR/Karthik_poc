...
INSERT INTO EBOOK_QA.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.2, 'Added EBOOK_AUTHORITY_QA.DOC_SIZE,EBOOK_AUTHORITY_QA.SPLIT_BOOK_TITLE_ID columns', TO_DATE('05052015', 'MMDDYYYY'));
...
--Lock
INSERT INTO EBOOK_QA.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.3, 'Added EBOOK_DEFINITION_QA.IS_SPLIT_LOCK column', TO_DATE('04212015', 'MMDDYYYY'));

ALTER TABLE EBOOK_QA.EBOOK_DEFINITION ADD (IS_SPLIT_LOCK  CHAR(1 BYTE) DEFAULT 'Y' NOT NULL);
