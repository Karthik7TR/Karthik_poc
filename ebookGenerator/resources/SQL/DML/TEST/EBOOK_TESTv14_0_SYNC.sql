...
ALTER TABLE EBOOK_TEST.DOCUMENT_TYPE_CODES ADD (THRESHOLD_VALUE NUMBER DEFAULT 7500 NOT NULL, THRESHOLD_PERCENT NUMBER DEFAULT 10 NOT NULL);
...
ALTER TABLE "EBOOK_TEST"."USER_PREFERENCE"
...
VALUES (14.10, 'Alter EBOOK_AUDIT.PROVIEW_TABLE_VIEW_FLAG column.', TO_DATE('04/27/2016', 'MM/DD/YYYY'));
 ...
 INSERT INTO EBOOK_TEST.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.10, 'Added EBOOK.PILOT_BOOK table.', TO_DATE('06/16/2016', 'MM/DD/YYYY'));

CREATE TABLE EBOOK_TEST.PILOT_BOOK(
...
ALTER TABLE EBOOK_TEST.PILOT_BOOK ADD CONSTRAINT PILOT_BOOK_PK PRIMARY KEY (PILOT_BOOK_TITLE_ID, EBOOK_DEFINITION_ID);

ALTER TABLE EBOOK_TEST.PILOT_BOOK ADD CONSTRAINT EBOOK_PILOT_BOOK_FK1 FOREIGN KEY (EBOOK_DEFINITION_ID) REFERENCES EBOOK_TEST.EBOOK_DEFINITION (EBOOK_DEFINITION_ID);

CREATE INDEX EBOOK_TEST.IX_EBOOK_PILOT_BOOK_FK1 ON EBOOK_TEST.PILOT_BOOK (EBOOK_DEFINITION_ID) ;

ALTER TABLE EBOOK_TEST.EBOOK_AUDIT
 ADD (PILOT_BOOKS_CONCAT  VARCHAR2(1024 BYTE));

 GRANT DELETE, INSERT, SELECT, UPDATE ON EBOOK_TEST.PILOT_BOOK TO EBOOK_TEST_USER;
 
CREATE OR REPLACE SYNONYM EBOOK_TEST_USER.PILOT_BOOK FOR EBOOK_TEST.PILOT_BOOK;
