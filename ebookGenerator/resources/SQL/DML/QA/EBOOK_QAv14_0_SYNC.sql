...
CREATE INDEX EBOOK_QA.IX_SPLIT_DOCUMENT_FK ON EBOOK_QA.SPLIT_DOCUMENT (EBOOK_DEFINITION_ID);


ALTER TABLE EBOOK_QA.SPLIT_DOCUMENT ADD CONSTRAINT SPLIT_DOCUMENT_FK FOREIGN KEY (EBOOK_DEFINITION_ID) REFERENCES EBOOK_QA.EBOOK_DEFINITION (EBOOK_DEFINITION_ID);
...
ALTER TABLE "EBOOK_QA"."USER_PREFERENCE"
 ADD (GROUP_NAME_FILTER  VARCHAR2(1024 BYTE),
 	  GROUP_ID_FILTER  VARCHAR2(1024 BYTE));
 	 
 	  
-- Increasing group column 	  
 	  
INSERT INTO EBOOK_QA.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.9, 'Alter EBOOK_DEFINITION.GROUP_NAME,EBOOK_AUDIT.GROUP_NAME,EBOOK_DEFINITION.SUBGROUP_HEADING,EBOOK_AUDIT.SUBGROUP_HEADING columns.', TO_DATE('04/27/2016', 'MM/DD/YYYY'));

ALTER TABLE EBOOK_QA.EBOOK_DEFINITION
 MODIFY (GROUP_NAME  Varchar2(1024 BYTE));
 
ALTER TABLE EBOOK_QA.EBOOK_AUDIT
 MODIFY (GROUP_NAME  Varchar2(1024 BYTE));
 
ALTER TABLE EBOOK_QA.EBOOK_DEFINITION
 MODIFY (SUBGROUP_HEADING  Varchar2(1024 BYTE));
 
ALTER TABLE EBOOK_QA.EBOOK_AUDIT
 MODIFY (SUBGROUP_HEADING  Varchar2(1024 BYTE));
 
  -- Not consistent in environmnets //This needs to be addressed later
 INSERT INTO EBOOK_QA.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.10, 'Alter EBOOK_AUDIT.PROVIEW_TABLE_VIEW_FLAG column.', TO_DATE('04/27/2016', 'MM/DD/YYYY'));
 
 ALTER TABLE EBOOK_QA.EBOOK_AUDIT
 MODIFY (PROVIEW_TABLE_VIEW_FLAG  CHAR(1 BYTE));
 
 COMMIT;
 
INSERT INTO EBOOK_QA.SCHEMA_VERSION (SCHEMA_VERSION, COMMENTS, CHANGE_DATE)
VALUES (14.10, 'Added EBOOK_QA.PILOT_BOOK table.', TO_DATE('06/16/2016', 'MM/DD/YYYY'));

CREATE TABLE EBOOK_QA.PILOT_BOOK(
  PILOT_BOOK_TITLE_ID VARCHAR2(40 BYTE) NOT NULL,
  EBOOK_DEFINITION_ID Number NOT NULL,
...
ALTER TABLE EBOOK_QA.PILOT_BOOK ADD CONSTRAINT PILOT_BOOK_PK PRIMARY KEY (PILOT_BOOK_TITLE_ID, EBOOK_DEFINITION_ID);

ALTER TABLE EBOOK_QA.PILOT_BOOK ADD CONSTRAINT EBOOK_PILOT_BOOK_FK1 FOREIGN KEY (EBOOK_DEFINITION_ID) REFERENCES EBOOK_QA.EBOOK_DEFINITION (EBOOK_DEFINITION_ID);

CREATE INDEX EBOOK_QA.IX_EBOOK_PILOT_BOOK_FK1 ON EBOOK_QA.PILOT_BOOK (EBOOK_DEFINITION_ID) ;

ALTER TABLE EBOOK_QA.EBOOK_AUDIT
 ADD (PILOT_BOOKS_CONCAT  VARCHAR2(1024 BYTE));

 GRANT DELETE, INSERT, SELECT, UPDATE ON EBOOK_QA.PILOT_BOOK TO EBOOK_QA_USER;
 
CREATE OR REPLACE SYNONYM EBOOK_QA_USER.PILOT_BOOK FOR EBOOK_QA.PILOT_BOOK;