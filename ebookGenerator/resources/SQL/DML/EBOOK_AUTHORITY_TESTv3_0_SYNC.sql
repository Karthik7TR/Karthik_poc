...
CREATE TABLE "EBOOK_AUTHORITY_TEST"."PACE_METADATA"(
...
ALTER TABLE "EBOOK_AUTHORITY_TEST"."PACE_METADATA" ADD CONSTRAINT "PK_PACE_METADATA" PRIMARY KEY ("PUBLICATION_ID")
/
