...
-- Table EBOOK_QA.EXCLUDE_DOCUMENT

CREATE TABLE "EBOOK_QA"."EXCLUDE_DOCUMENT"(
...
-- Add keys for table EBOOK_QA.EXCLUDE_DOCUMENT

ALTER TABLE "EBOOK_QA"."EXCLUDE_DOCUMENT" ADD CONSTRAINT "PK_EXCLUDE_DOCUMENT" PRIMARY KEY ("EBOOK_DEFINITION_ID","DOCUMENT_GUID")
/

CREATE INDEX "EBOOK_QA"."IX_EXCLUDE_DOCUMENT_FK" ON "EBOOK_QA"."EXCLUDE_DOCUMENT" ("EBOOK_DEFINITION_ID") 
/
ALTER TABLE "EBOOK_QA"."EXCLUDE_DOCUMENT" ADD CONSTRAINT "EXCLUDE_DOCUMENT_FK" FOREIGN KEY ("EBOOK_DEFINITION_ID") REFERENCES "EBOOK_QA"."EBOOK_DEFINITION" ("EBOOK_DEFINITION_ID")
/

ALTER TABLE EBOOK_QA.EBOOK_AUDIT
 ADD (EXCLUDED_DOCUMENTS_CONCAT  VARCHAR2(2048 BYTE));
 
-- Table EBOOK_QA.JOB_HISTORY

CREATE TABLE "EBOOK_QA"."JOB_HISTORY"(
...
-- Add keys for table EBOOK_QA.JOB_HISTORY

ALTER TABLE "EBOOK_QA"."JOB_HISTORY" ADD CONSTRAINT "PK_JOB_HISTORY" PRIMARY KEY ("STEP_EXECUTION_ID")
/
