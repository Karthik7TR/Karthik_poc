...
CREATE TABLE "EBOOK_CONFIG"."PLANNED_OUTAGE"(
...
ALTER TABLE "EBOOK_CONFIG"."PLANNED_OUTAGE" ADD CONSTRAINT "PK_PLANNED_OUTAGE" PRIMARY KEY ("OUTAGE_ID")
/

-- Table EBOOK_CONFIG.OUTAGE_TYPE

CREATE TABLE "EBOOK_CONFIG"."OUTAGE_TYPE"(
  "OUTAGE_TYPE_ID" Number NOT NULL,
...
-- Add keys for table EBOOK_CONFIG.OUTAGE_TYPE

ALTER TABLE "EBOOK_CONFIG"."OUTAGE_TYPE" ADD CONSTRAINT "PK_OUTAGE_TYPE" PRIMARY KEY ("OUTAGE_TYPE_ID")
/

ALTER TABLE "EBOOK_CONFIG"."PLANNED_OUTAGE" ADD CONSTRAINT "REL_1" FOREIGN KEY ("OUTAGE_TYPE_ID") REFERENCES "EBOOK_CONFIG"."OUTAGE_TYPE" ("OUTAGE_TYPE_ID")
/

CREATE SEQUENCE "EBOOK_CONFIG"."OUTAGE_ID_SEQ"
 INCREMENT BY 1
 START WITH 1
 NOMAXVALUE
 NOMINVALUE
...
CREATE SEQUENCE "EBOOK_CONFIG"."OUTAGE_TYPE_ID_SEQ"
 INCREMENT BY 1
 START WITH 1
 NOMAXVALUE
 NOMINVALUE
