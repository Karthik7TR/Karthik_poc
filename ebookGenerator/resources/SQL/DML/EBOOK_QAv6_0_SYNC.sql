...
-- Table EBOOK_QA.USER_PREFERENCE

CREATE TABLE "EBOOK_QA"."USER_PREFERENCE"(
...
-- Add keys for table EBOOK_QA.USER_PREFERENCE

ALTER TABLE "EBOOK_QA"."USER_PREFERENCE" ADD CONSTRAINT "PK_USER_PREFERENCE" PRIMARY KEY ("USER_NAME")
/
