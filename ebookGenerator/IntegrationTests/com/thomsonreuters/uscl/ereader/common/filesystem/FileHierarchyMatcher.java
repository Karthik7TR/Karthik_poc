...
public final class FileHierarchyMatcher extends BaseMatcher<Object>
{
    ...
    public boolean matches(final Object item)
    {
        ...
        final List<File> actualFileList = (List<File>) FileUtils.listFiles(actual, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
        final List<File> expectedFileList = (List<File>) FileUtils.listFiles(file, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
