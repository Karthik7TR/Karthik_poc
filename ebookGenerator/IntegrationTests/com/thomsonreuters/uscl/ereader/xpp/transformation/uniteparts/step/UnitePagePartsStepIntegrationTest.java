...
public final class UnitePagePartsStepIntegrationTest {
    ...
    public void setUp() throws URISyntaxException, IOException {
        ...
        mainPart = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPartFileName(BASE_FILENAME, 1, PartType.MAIN, DOC_FAMILY_GUID)).toURI());
        footnotesPart = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPartFileName(BASE_FILENAME, 1, PartType.FOOTNOTE, DOC_FAMILY_GUID)).toURI());
        mainPartTwo = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPartFileName(BASE_FILENAME_TWO, 1, PartType.MAIN, DOC_FAMILY_GUID_TWO))
                .toURI());
        footnotesPartTwo = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPartFileName(BASE_FILENAME_TWO, 1, PartType.FOOTNOTE, DOC_FAMILY_GUID_TWO))
                .toURI());

        expected = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPageFileName(BASE_FILENAME, 1, DOC_FAMILY_GUID)).toURI());
        expectedTwo = new File(
            UnitePagePartsStepIntegrationTest.class
                .getResource(fileSystem.getPageFileName(BASE_FILENAME_TWO, 1, DOC_FAMILY_GUID_TWO)).toURI());
    }
    ...
    public void shouldUnitePageParts() throws Exception {
        ...
        final File actualTwo =
            fileSystem.getOriginalPageFile(step, MATERIAL_NUMBER_2, BASE_FILENAME_TWO, 1, DOC_FAMILY_GUID_TWO);
