...
public final class SplitOriginalStepIntegrationTest {
    ...
    public void setUp() throws URISyntaxException {
        ...
        expectedMainPart1 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(1, PartType.MAIN, SECTION_1_UUID)).toURI());
        expectedMainPart2 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(2, PartType.MAIN, SECTION_2_UUID)).toURI());
        expectedMainPart3 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(3, PartType.MAIN, SECTION_3_UUID)).toURI());
        expectedMainPart4 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(4, PartType.MAIN, SECTION_4_UUID)).toURI());

        expectedFootnotesPart1 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(1, PartType.FOOTNOTE, SECTION_1_UUID))
                .toURI());
        expectedFootnotesPart2 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(2, PartType.FOOTNOTE, SECTION_2_UUID))
                .toURI());
        expectedFootnotesPart3 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(3, PartType.FOOTNOTE, SECTION_3_UUID))
                .toURI());
        expectedFootnotesPart4 = new File(
            SplitOriginalStepIntegrationTest.class.getResource(getFileName(4, PartType.FOOTNOTE, SECTION_4_UUID))
                .toURI());
    }
    ...
    public void shouldSplitOriginalXml() throws Exception {
        ...
        final File actualMainPart1 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_1_UUID, PartType.MAIN).getFile();
        final File actualMainPart2 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_2_UUID, PartType.MAIN).getFile();
        final File actualMainPart3 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_3_UUID, PartType.MAIN).getFile();
        final File actualMainPart4 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_4_UUID, PartType.MAIN).getFile();

        final File actualFootnotesPart1 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_1_UUID, PartType.FOOTNOTE).getFile();
        final File actualFootnotesPart2 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_2_UUID, PartType.FOOTNOTE).getFile();
        final File actualFootnotesPart3 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_3_UUID, PartType.FOOTNOTE).getFile();
        final File actualFootnotesPart4 =
            partFilesIndex.get(MATERIAL_NUMBER, BASE_FILE_NAME, SECTION_4_UUID, PartType.FOOTNOTE).getFile();
