        ...
        public void setUp()
        {
            final DbSetup dbSetup = new DbSetup(
                ...
                sequenceOf(
                    ...
                    insertInto("XPP_BUNDLE_ARCHIVE").columns("XPP_BUNDLE_ARCHIVE_ID", "DATE_TIME", "MESSAGE_ID", "MESSAGE_REQUEST", "MATERIAL_NUMBER", "DELETED", "ARCHIVE_LOCATION", "RESURRECT_COUNT")
                        .values("666666",  new DateTime(2017, 2, 14, 17, 3, 0).toDate(), "I9dac72105cc011e789a4fa23e76ecab4", "message1", SAME_MATERIAL_NUMBER, "N", "/apps/eBookBuilder/cicontent/xpp/archive/2017/06/test_bundle.zip", 0)
                        .values("777777",  new DateTime(2017, 2, 16, 17, 3, 0).toDate(), "I9dac72105cc011e789a4fa23e76ecab5" , "message2", SAME_MATERIAL_NUMBER, "N", "/apps/eBookBuilder/cicontent/xpp/archive/2017/06/test_bundle.zip", 0)
                        .values("888888",  new DateTime(2017, 2, 18, 17, 3, 0).toDate(), "I9dac72105cc011e789a4fa23e76ecab6", "message3", SAME_MATERIAL_NUMBER, "N", "/apps/eBookBuilder/cicontent/xpp/archive/2017/06/test_bundle.zip", 0)
                        .build()));
            dbSetup.launch();
        }
