...
public class ProviewClientImplTest {
	...
	public void testGetAllProviewGroups() throws Exception {
		...
		EasyMock.expect(mockRestTemplate.execute(allGroupsUriTemplate, HttpMethod.GET, mockRequestCallback, mockResponseExtractor,
				urlParameters)).andReturn(response);

		replayAll();
		String proviewGroups = proviewClient.getAllProviewGroups();
	...
	public void testGetProviewGroupContainerById() throws Exception {
		...
		String response = "<groups><group id=\"" + groupId + "\" status=\"Test\" version=\"v1\">"
				...
				+ "<members><subgroup><title>test1</title><title>test2</title></subgroup></members>" + "</group></groups>";
		...
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute(singleGroupUriTemplate, HttpMethod.GET, mockXMLRequestCallback, mockResponseExtractor,
				urlParameters)).andReturn(response);
		replayAll();

		String groupContainer = proviewClient.getProviewGroupById(groupId);
	...
	public void testGetProviewGroupInfo() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getXMLRequestCallback()).andReturn(mockXMLRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute("http://" + PROVIEW_DOMAIN_PREFIX + getTitlesUriTemplate, HttpMethod.GET,
				mockXMLRequestCallback, mockResponseExtractor, createURLParameters())).andReturn("");
	...
	public void testCreateGroup() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getXMLRequestCallback()).andReturn(mockXMLRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute("http://" + PROVIEW_DOMAIN_PREFIX + getTitlesUriTemplate, HttpMethod.PUT,
				mockXMLRequestCallback, mockResponseExtractor, createURLParameters())).andReturn("");

		replayAll();
		String response = proviewClient.createGroup("uscl/groupTest", "v1", "<group></group>");
		System.out.println("response " + response);
		verifyAll();
	...
	public void testPromoteGroup() throws Exception {
		...
		replayAll();
		String response = proviewClient.promoteGroup("uscl/groupTest", "v1");
		System.out.println("response " + response);
		verifyAll();
	...
	public void testRemoveGroup() throws Exception {
		...
		replayAll();
		String response = proviewClient.removeGroup("uscl/groupTest", "v1");
		System.out.println("response " + response);
		verifyAll();
	...
	public void testDeleteGroup() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getXMLRequestCallback()).andReturn(mockXMLRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute("http://" + PROVIEW_DOMAIN_PREFIX + getTitlesUriTemplate, HttpMethod.DELETE,
				mockXMLRequestCallback, mockResponseExtractor, createURLParameters())).andReturn("");

		replayAll();
		String response = proviewClient.deleteGroup("uscl/groupTest", "v1");
		System.out.println("response " + response);
		verifyAll();
	...
	public void testGetLatestProviewTitleInfo() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getStreamRequestCallback()).andReturn(mockRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute("http://" + PROVIEW_DOMAIN_PREFIX + singleTitleTemplate, HttpMethod.GET,
				mockRequestCallback, mockResponseExtractor, urlParameters)).andReturn(response);

		replayAll();
		String titleInfo = proviewClient.getSinglePublishedTitle("uscl/sc/ca_evid");
	...
	public void testGetSingleTitleGroupDetails() throws Exception {
		...
		replayAll();
		String groupDetailsList = proviewClient.getSinglePublishedTitle("uscl/sc/ca_evid");
	...
	public void testGetAllLatestProviewTitleInfo() throws Exception {
		...
		replayAll();
		String titleInfo = proviewClient.getAllPublishedTitles();
		verifyAll();
	...
	public void getSingleTitleInfoByVersion() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getXMLRequestCallback()).andReturn(mockXMLRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute("http://" + PROVIEW_DOMAIN_PREFIX + singleTitleByVersionUriTemplate, HttpMethod.GET,
				mockXMLRequestCallback, mockResponseExtractor, urlParameters)).andReturn("");
	...
	public void testPublishTitle() throws Exception {
		...
		try {
			...
			EasyMock.expect(mockRequestCallbackFactory.getStreamRequestCallback()).andReturn(mockRequestCallback);
			EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
			EasyMock.expect(mockRestTemplate.execute(publishTitleUriTemplate, HttpMethod.PUT, mockRequestCallback, mockResponseExtractor,
					urlParameters)).andReturn("=)");
	...
	public void testPromoteTitle() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getStreamRequestCallback()).andReturn(mockRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute(promoteTitleUriTemplate, HttpMethod.PUT, mockRequestCallback, mockResponseExtractor,
				urlParameters)).andReturn("=)");
	...
	public void testRemoveTitle() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getStreamRequestCallback()).andReturn(mockRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute(removeTitleUriTemplate, HttpMethod.PUT, mockRequestCallback, mockResponseExtractor,
				urlParameters)).andReturn("=)");
		EasyMock.expectLastCall();
		replayAll();
	...
	public void testDeleteTitle() throws Exception {
		...
		EasyMock.expect(mockRequestCallbackFactory.getStreamRequestCallback()).andReturn(mockRequestCallback);
		EasyMock.expect(mockResponseExtractorFactory.getResponseExtractor()).andReturn(mockResponseExtractor);
		EasyMock.expect(mockRestTemplate.execute(deleteTitleUriTemplate, HttpMethod.DELETE, mockRequestCallback, mockResponseExtractor,
				urlParameters)).andReturn("=)");
		EasyMock.expectLastCall();
		replayAll();
