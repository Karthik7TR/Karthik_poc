...
{
    private static final String DOCS_RESPONSE = "<docs><doc id=\"doc1\" src=\"doc1.html\"/><doc id=\"doc2\" src=\"doc2.html\"/></docs>";
    ...
    private static final String TITLE_RESPONSE = "<title apiversion=\"v1\""
        ...
        + " language=\"eng\""
        + " status=\"Review\""
        + " onlineexpiration=\"29991231\">" + "<material>test</material></title>";
    ...
    {
        given(proviewClient.getSingleTitleInfoByVersion(eq(DOCS_TITLE_ID), anyString()))
            .willReturn(DOCS_RESPONSE);
        given(proviewClient.getSinglePublishedTitle(VERSION_TITLE_ID))
            .willReturn(TITLE_RESPONSE);
        given(proviewClient.getTitleInfo(DOCS_TITLE_ID, "v1.0"))
            .willReturn(DOCS_RESPONSE);
