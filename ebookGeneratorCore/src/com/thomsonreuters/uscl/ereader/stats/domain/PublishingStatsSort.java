...
public class PublishingStatsSort {
	 ...
	 */
	public enum SortProperty { JOB_INSTANCE_ID, AUDIT_ID, EBOOK_DEFINITION_ID, JOB_SUBMITTER, JOB_SUBMIT_TIMESTAMP, 
		BOOK_VERSION, PUBLISH_STATUS, BOOK_SIZE, LARGEST_DOC_SIZE, LARGEST_IMAGE_SIZE, LARGEST_PDF_SIZE, PROVIEW_DISPLAY_NAME, TITLE_ID } // publishing stats properties that can be sorted on
	 ...
	 */
	public PublishingStatsSort(SortProperty sortProperty, boolean ascending, int pageNumber, int itemsPerPage) {
