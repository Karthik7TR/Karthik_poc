...
public class QueueManager
{
	...
	private List<QueueDescriptor> descriptors = new ArrayList<QueueDescriptor>();
	...
	public boolean sendMessageToQueue(final String messageText, final Map<String, String> properties)
	{
		if (enabled)
		{
			...
			{
				log.error(queueMessage("Error sending message - changing destination and retrying"));
	...
	private synchronized void initialize(final QueueDescriptor descriptor) throws JMSException
	{
		final QueueConnectionFactory connectionFactory =
			factory.getNewQueueConnectionFactory(
				descriptor.getHost(),
				descriptor.getPort(),
