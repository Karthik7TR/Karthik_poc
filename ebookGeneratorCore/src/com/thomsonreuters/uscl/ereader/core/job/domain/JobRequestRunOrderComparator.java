...
public class JobRequestRunOrderComparator implements Comparator<JobRequest>
{
     ...
     */
    public static int compareJobPriority(final int priority1, final Date submittedAt1, final int priority2, final Date submittedAt2)
    {
