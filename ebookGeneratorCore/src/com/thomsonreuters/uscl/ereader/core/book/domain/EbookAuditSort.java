...
public class EbookAuditSort {
	 ...
	 */
	public enum SortProperty { TITLE_ID, BOOK_NAME, BOOK_DEFINITION_ID, SUBMITTED_DATE, ACTION, SUBMITTED_BY };  // Book properties that can be sorted on
	 ...
	 */
	public EbookAuditSort(SortProperty sortProperty, boolean ascending, int pageNumber, int itemsPerPage) {
