...
public final class PageNumberUtil {
    ...
    public static final String VOL_ONE = "1";
    ...
    private static final String VOL_NUMBER = "v%s-%s";
    ...
    public static void setLabelNo(final Node pagebreak, final String labelNo) {
        pagebreak.attr(LABEL_NO, labelNo);
    }

    public static String getVol(final Node pagebreak) {
        return pagebreak.attr(VOL);
    }

    public static void addVolumeToPageNumber(final Element pagebreak) {
        String label = getLabelNo(pagebreak);
        String vol = getVol(pagebreak);
        if (StringUtils.isNotEmpty(vol)) {
            setLabelNo(pagebreak, String.format(VOL_NUMBER, vol, label));
        }
    }
