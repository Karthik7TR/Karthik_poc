            ...
            while (r.hasNext())
            {
                ...
                if (event.isStartElement())
                {
                    ...
                    if (element.getName().getLocalPart().equalsIgnoreCase(GROUP))
                    {
                        ...
                        final Attribute statusAttr = element.asStartElement().getAttributeByName(new QName(GROUP_STATUS));
                        final Attribute versionAttr = element.asStartElement().getAttributeByName(new QName(GROUP_VERSION));
                ...
                if (event.isEndElement() && groupDefinition!=null)
                {
                    ...
                    else if (element.getName().getLocalPart().equalsIgnoreCase(SUBGROUP_TITLE) && subGroupInfo != null)
                    {
