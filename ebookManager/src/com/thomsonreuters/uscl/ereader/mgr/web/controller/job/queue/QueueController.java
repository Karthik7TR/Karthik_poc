...
public class QueueController {
    ...
    private void setUpModel(
        ...
        final PaginatedList queuedPaginatedList = createPaginatedList(allQueuedJobs, queuedPageAndSort);
    ...
    private PaginatedList createPaginatedList(
        ...
        final QueuePaginatedList<DisplayTagSortProperty> paginatedList = new QueuePaginatedList<>(
            onePageOfRows,
            allQueuedJobs.size(),
            queuedPageAndSort.getPageNumber(),
            queuedPageAndSort.getObjectsPerPage(),
            queuedPageAndSort.getSortProperty(),
            queuedPageAndSort.isAscendingSort());
    ...
    private List<JobRequest> createOnePageOfRows(
        ...
        final int fromIndex = (queuedPageAndSort.getPageNumber() - 1) * queuedPageAndSort.getObjectsPerPage();
