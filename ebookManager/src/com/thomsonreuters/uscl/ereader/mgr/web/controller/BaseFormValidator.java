...
public abstract class BaseFormValidator
{
    ...
    protected void checkMaxLength(final Errors errors, final int maxValue, final String text, final String fieldName, final Object[] args)
    {
    ...
    protected void checkSpecialCharacters(final Errors errors, final String text, final String fieldName, final boolean includeUnderscore)
    {
        if (StringUtils.isNotEmpty(text))
        {
    ...
    protected static void validateDate(final String dateString, final Date parsedDate, final String label, final Errors errors)
    {
