...
/**
 * A DisplayTag PaginatedList implementation for paging through the part lists of Proview Group List.
 */
public class ProviewGroupPaginatedList implements PaginatedList {

    private List<ProviewGroup> partialList;
    ...
    private ProviewGroupForm.DisplayTagSortProperty sortProperty; // Indicates the property that we want to sort by
     ...
     */
    public ProviewGroupPaginatedList(
            final List<ProviewGroup> partialList,
            final int fullListSize,
            final int pageNumber,
            final int itemsPerPage,
            final ProviewGroupForm.DisplayTagSortProperty sortProperty,
    ...
    @Override
    public List<ProviewGroup> getList() {
        return partialList;
    }
