...
public class JurisdictionCodeFormValidator extends BaseFormValidator implements Validator {
	//private static final Logger log = Logger.getLogger(JurisdictionCodeFormValidator.class);
    ...
    public void validate(Object obj, Errors errors) {
    	...
    	JurisdictionCodeForm form = (JurisdictionCodeForm) obj;
    	...
    	if(!StringUtils.isBlank(name)) {
	    	JurisTypeCode code = codeService.getJurisTypeCodeByName(name);
