...
public class FileStreamController {
	...
	public void getCoverImage(@RequestParam("imageName") String imageName, HttpServletRequest request,
	...
	public void getFrontMatterImage(@RequestParam("imageName") String imageName, HttpServletRequest request,
			HttpServletResponse response) {
	...
	public void getFrontMatterCss(@RequestParam("cssName") String cssName, HttpServletRequest request,
			HttpServletResponse response) {

		retrieveFile(request, response, WebConstants.LOCATION_FRONT_MATTER_CSS, cssName, "text/css");
	}

	private void retrieveFile(HttpServletRequest request, HttpServletResponse response, String nasLocation,
