...
public class PublishingStatsExcelExportService extends BaseExcelExportService {
	...
	public static final String[] STATS_HEADER = { "TITLE_ID", "PROVIEW_DISPLAY_NAME", "JOB_INSTANCE_ID", "AUDIT_ID",
			"EBOOK_DEFINITION_ID", "BOOK_VERSION_SUBMITTED", "JOB_HOST_NAME", " JOB_SUBMITTER_NAME",
			" JOB_SUBMIT_TIMESTAMP", "PUBLISH_START_TIMESTAMP", "GATHER_TOC_NODE_COUNT", "GATHER_TOC_SKIPPED_COUNT",
			"GATHER_TOC_DOC_COUNT", "GATHER_TOC_RETRY_COUNT", "GATHER_DOC_EXPECTED_COUNT", "GATHER_DOC_RETRY_COUNT",
			"GATHER_DOC_RETRIEVED_COUNT", "GATHER_META_EXPECTED_COUNT", "GATHER_META_RETRIEVED_COUNT",
			"GATHER_META_RETRY_COUNT", "GATHER_IMAGE_EXPECTED_COUNT", "GATHER_IMAGE_RETRIEVED_COUNT",
			"GATHER_IMAGE_RETRY_COUNT", "FORMAT_DOC_COUNT", "TITLE_DOC_COUNT", "TITLE_DUP_DOC_COUNT", "PUBLISH_STATUS",
