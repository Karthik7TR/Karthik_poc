...
public class EBookManagerLdapConfig
{
    ...
    public LdapContextSource tlrLdapContextSource()
    {
        ...
        source.setUserDn("CN=svcCTWebSphere,OU=Service - Application Accounts,OU=Administrative Accounts,"
    ...
    public LdapContextSource tenLdapContextSource()
    {
        ...
        source.setUserDn("CN=s.cobalt.ebookbuilder,OU=Service Accounts,OU=Admin,OU=MSP01,DC=ten,DC=thomsonreuters,DC=com");
        source.setPassword("Iaw*:C@DAA");
        return source;
    }
}
