...
<script type="text/javascript">
	...
	window.onbeforeunload = function() { 
	  if (warning) {
	    return "Navigating away from this page without using the Save or Cancel button will keep the book Definition locked.  Please use the Save or Cancel button below to unlock the eBook Definition so other users will be able to edit.";
	  }
	};
