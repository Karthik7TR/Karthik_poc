...
public class JobSummaryControllerTest {
    ...
    /**
     * Test the happy path POST of a new set of search criteria that contain validation errors
     */
    @Test
    ...
    private void validateModel(Map<String,Object> model) {
        ...
        assertNotNull(model.get(WebConstants.KEY_JOB_NAMES));
        assertNotNull(model.get(WebConstants.KEY_PAGINATED_LIST));
        assertNotNull(httpSession.getAttribute(WebConstants.KEY_PAGINATED_LIST));
    }
}
